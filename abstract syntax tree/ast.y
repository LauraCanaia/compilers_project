...
E: E'+'T    {$$=newNode(getPointer('+'));addChild($$,$1,$3);}
  |E'-'T    {$$=newNode(getPointer('-'));addChild($$,$1,$3);}
  |T        {$$=$1;}
  ;  


T: T'*'F    {$$=newNode(getPointer('*'));addChild($$,$1,$3);}
  |T'/'F    {$$=newNode(getPointer('/'));addChild($$,$1,$3);}
  |T'%'F    {$$=newNode(getPointer('%'));addChild($$,$1,$3);}
  |F        {$$=$1;}
  ;   
