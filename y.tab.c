...
{
  "$end", "error", "$undefined", "NUMBER", "DIRECTION", "'\\n'",
  "$accept", "all", "expressions", "exp", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  case 2:
#line 29 "taxyway.y"
                       {checkCoord((yyval.coord));}
#line 1311 "y.tab.c"
    break;

  case 3:
#line 31 "taxyway.y"
                              {(yyval.coord)=sumCoord((yyvsp[-1].coord),(yyvsp[0].coord));}
#line 1317 "y.tab.c"
    break;
...
#line 1323 "y.tab.c"
  ...
  case 5:
#line 34 "taxyway.y"
                        {(yyval.coord)=getRelativeCoord((yyvsp[-1].string), (yyvsp[0].number));}
#line 1329 "y.tab.c"
    break;
